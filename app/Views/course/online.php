                            ...
                            <div class="down-content">
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="pills-description" role="tabpanel" aria-labelledby="pills-description-tab">
                                        ...
                                        <p>KELAS <text style="color:orange">ONLINE</text></p>
                                        ...
                                        <h5>ZOOM MEETING</h5>
                                        <hr>
                                        <p style="text-align: justify;">Kami menggunakan Zoom Meeting untuk Online Class. Metode belajar jarak jauh “distance learning” interaktif dimana para peserta dan pengajar tidak bertatap muka langsung secara fisik.</p>
                                        <br>
                                        ...
                                        <ol>
                                            ...
                                            <li>7x Pertemuan Kelas Pembahasan Materi (@ 6 jam) dan rekaman.</li>
                                            <li>3x Tryout Komprehensif Online dan Pembahasan.</li>
                                            <li>6x Pertemuan Kelas Drilling Ujian (@ 3 jam) dan rekaman.</li>
                                    ...
                                    <div class="tab-pane fade" id="pills-announcement" role="tabpanel" aria-labelledby="pills-announcement-tab">
                                        <h4>Pendaftaran Peserta Online Class</h4>
                                        <br>
                                        ...
                                        <ol>
                                            ...
                                            <li>
                                                ...
                                                <p style="text-align: justify;">Biaya Diklat Ahli Kepabeanan PPJK Kelas Offline Eksekutif adalah
                                                    <!-- <text style="text-decoration:line-through"><?= $reguler_course_fee_rp ?></text>  -->
                                                    <?= $online_course_fee_promo_rp ?> / peserta. Biaya ini belum termasuk Biaya Ujian Sertifikasi Ahli Kepabeanan oleh Pusdiklat Bea Cukai.
                                                </p>
                                            </li>
                                            <br>
                                            <li>
                                                ...
                                                <ol type="a" class="ps-4">
                                                    <li>Pembayaran Pertama: Rp 1.500.000 paling lambat sebelum sesi 1 Pembelajaran.</li>
                                                    <li>Pembayaran Kedua: Rp 1.500.000 paling lambat 28 April 2023.</li>
                                                    <li>Pembayaran Ketiga: Rp 500.000 paling lambat 19 Mei 2023.</li>
                                                </ol>
                                                </p>
                                            </li>
                                            <br>
